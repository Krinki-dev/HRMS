...
/**
 * @file EmployeeImportPage.jsx
 * @description Mac-style graphical interface for bulk employee data ingestion.
 */
  ...
  return (
    <div>
      ...
      <div className="flex items-start justify-between mb-5 gap-4">
        ...
        <Button variant="outline" onClick={() => navigate('/employees')}>{THEME.ICONS.BACK} Back</Button>
      </div>

      {}
      <div className="grid grid-cols-3 gap-4 mb-5">
        {[
          { n:1, icon: THEME.ICONS.DOWNLOAD, title:'Download Template',
          ...
          { n:2, icon: THEME.ICONS.EDIT, title:'Fill Employee Data',
          ...
          { n:3, icon: THEME.ICONS.IMPORT, title:'Upload & Import',
            body:'Upload the filled file. All errors are shown before import runs — nothing is saved until you confirm.' },
        ].map(s => (
          <div key={s.n} className="bg-white rounded-2xl border border-gray-200 p-5 shadow-sm flex gap-3">
      ...
      {!result ? (
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 space-y-5">
          ...
          >
            <div className="text-4xl mb-3">{file ? THEME.ICONS.FILE : THEME.ICONS.FOLDER}</div>
            {file ? (
              <div>
                ...
                <p className="text-xs text-gray-500 mt-1">
                  ...
                  {rowErrors.length === 0 && parsedRows.length > 0 &&
                    <span className="text-green-600 ml-2">· {THEME.ICONS.SUCCESS} Ready to import</span>}
                </p>
              </div>
            ) : (
              <div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs text-green-600 bg-green-50 px-2 py-0.5 rounded">
                  {THEME.ICONS.SUCCESS} {parsedRows.length} valid rows
                </span>
              </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-lg p-10">
          <div className="text-center mb-6">
            <div className="text-5xl mb-3">{result.failed === 0 ? THEME.ICONS.SUCCESS : THEME.ICONS.WARNING}</div>
          ...
          <div className="grid grid-cols-3 gap-4 mb-6">
            {[
              ...
              <div key={s.label}
                className={`bg-${s.color}-50/50 border border-${s.color}-100 rounded-2xl p-6 text-center shadow-sm`}>
          ...
          {result.errors?.length > 0 && (
            <div className="border border-red-200 rounded-2xl overflow-hidden mb-5">
